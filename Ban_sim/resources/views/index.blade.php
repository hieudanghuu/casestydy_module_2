            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="map.html">
                                <i class="fas fa-map-marker-alt"></i>地図</a>
                        </li>
                        <li class="has-sub">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <h2 class="title-1 m-b-25">トップ製品</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('{{asset('CoolAdmin/images/bg-title-02.jpg')}}');">
                                        <div class="bg-overlay bg-overlay--blue"></div>
                                        <h3>
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="{{asset('CoolAdmin/images/icon/avatar-03.jpg')}}" alt="Nicholas Martinez">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="{{asset('CoolAdmin/images/icon/avatar-04.jpg')}}" alt="Michelle Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="{{asset('CoolAdmin/images/icon/avatar-05.jpg')}}" alt="Michelle Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">Michelle Sims</h5>
